...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    await queryInterface.addIndex('analytics_kpis', ['questionnaire_id'], {
      name: 'idx_analytics_kpis_questionnaire_id',
    });
    await queryInterface.addIndex('analytics_kpis', ['period_type'], {
      name: 'idx_analytics_kpis_period_type',
    });
    await queryInterface.addIndex('analytics_kpis', ['period_date'], {
      name: 'idx_analytics_kpis_period_date',
    });
    await queryInterface.addIndex('analytics_kpis', ['questionnaire_id', 'period_type', 'period_date'], {
