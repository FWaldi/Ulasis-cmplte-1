...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    await queryInterface.addIndex('analytics_trends', ['questionnaire_id'], {
      name: 'idx_analytics_trends_questionnaire_id',
    });
    await queryInterface.addIndex('analytics_trends', ['period_type'], {
      name: 'idx_analytics_trends_period_type',
    });
    await queryInterface.addIndex('analytics_trends', ['period_date'], {
      name: 'idx_analytics_trends_period_date',
    });
    await queryInterface.addIndex('analytics_trends', ['date'], {
      name: 'idx_analytics_trends_date',
    });
    await queryInterface.addIndex('analytics_trends', ['questionnaire_id', 'period_type', 'period_date', 'date'], {
