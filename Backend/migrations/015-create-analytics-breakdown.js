...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    await queryInterface.addIndex('analytics_breakdown', ['questionnaire_id'], {
      name: 'idx_analytics_breakdown_questionnaire_id',
    });
    await queryInterface.addIndex('analytics_breakdown', ['period_type'], {
      name: 'idx_analytics_breakdown_period_type',
    });
    await queryInterface.addIndex('analytics_breakdown', ['period_date'], {
      name: 'idx_analytics_breakdown_period_date',
    });
    await queryInterface.addIndex('analytics_breakdown', ['area'], {
      name: 'idx_analytics_breakdown_area',
    });
    await queryInterface.addIndex('analytics_breakdown', ['status'], {
      name: 'idx_analytics_breakdown_status',
    });
    await queryInterface.addIndex('analytics_breakdown', ['questionnaire_id', 'period_type', 'period_date', 'area'], {
