...
const QuestionnaireForm: React.FC<QuestionnaireFormProps> = ({ questionnaire, onSubmit }) => {
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="pt-4 border-t border-slate-200 dark:border-slate-700">
                <button type="submit" className="w-full bg-brand-primary text-white font-bold py-3 px-8 rounded-lg shadow-lg hover:bg-brand-secondary transform hover:-translate-y-0.5 transition-all duration-300">
                    Kirim Feedback
                </button>
            </div>
        </form>
