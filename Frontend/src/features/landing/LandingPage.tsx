...
import { ReportsIcon, OperationalControlIcon, RealTimeIcon, CheckIcon, QuoteIcon } from '../../../components/common/Icons';
...
const FeatureCard: React.FC<{ icon: React.ReactNode; title: string; children: React.ReactNode; className?: string }> = ({ icon, title, children, className }) => (
    <div className={`bg-white/5 dark:bg-white/5 backdrop-blur-sm p-6 rounded-xl border border-slate-300 dark:border-white/10 shadow-lg text-left opacity-100 ${className}`}>
    ...
    return (
        <>
                ...
                <main className="container mx-auto px-4 sm:px-6 lg:p-8 pt-20 md:pt-24 pb-20 relative z-10">
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div className="text-center lg:text-left">
                            <h2 className="text-4xl md:text-6xl font-extrabold tracking-tighter mb-4 leading-tight text-slate-900 dark:text-white opacity-100 animate-fade-in-up">
                                Setiap Ulasan Adalah Cerita. <span className="text-brand-primary dark:text-brand-accent">Sudahkah Anda Mendengarkan?</span>
                            </h2>
                            <p className="max-w-2xl text-lg text-slate-700 dark:text-slate-300 mb-8 opacity-100 animate-fade-in-up-delay-1">
                        ...
                        <div className="hidden lg:block opacity-100 animate-fade-in-up-delay-3">
            ...
            <section id="story-start" className="py-20 relative z-10">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                         <div className="opacity-100 animate-fade-in-up-delay-1">
                           <div className="relative bg-white dark:bg-slate-800/50 p-4 rounded-xl border border-slate-300 dark:border-white/10 shadow-2xl backdrop-blur-sm">
                        ...
                        <div className="opacity-100 animate-fade-in-up">
            ...
            <section id="features" className="py-20 relative z-10 bg-slate-100 dark:bg-slate-800/50">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                     <div className="text-center mb-12 opacity-100 animate-fade-in-up">
            ...
            <section className="py-20 relative z-10 bg-slate-100 dark:bg-slate-800/50">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
                        <div className="flex flex-col items-center opacity-100 animate-fade-in-up">
                        ...
                        <div className="flex flex-col items-center opacity-100 animate-fade-in-up-delay-1">
                        ...
                        <div className="flex flex-col items-center opacity-100 animate-fade-in-up-delay-2">
                        ...
                        <div className="flex flex-col items-center opacity-100 animate-fade-in-up-delay-3">
            ...
            <section className="py-20 relative z-10">
                 <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12 opacity-100 animate-fade-in-up">
                     ...
                     <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                         <div className="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg opacity-100 animate-fade-in-up">
                         ...
                         <div className="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg opacity-100 animate-fade-in-up-delay-1">
                              <QuoteIcon className="w-8 h-8 text-slate-300 dark:text-slate-600 mb-4" />
                          ...
                          <div className="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg opacity-100 animate-fade-in-up-delay-2">
                              <QuoteIcon className="w-8 h-8 text-slate-300 dark:text-slate-600 mb-4" />
             ...
             <section className="py-20 relative z-10">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="bg-slate-100 dark:bg-slate-800/50 rounded-2xl p-10 md:p-16 text-center shadow-inner-lg border border-slate-200 dark:border-slate-700/50 opacity-100 animate-fade-in-up">
             ...
             <section id="pricing" className="py-20 relative z-10 bg-slate-100 dark:bg-slate-800/50">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
                        {/* Pricing Card 1 - Free */}
                        <div className="border border-slate-200 dark:border-slate-700 rounded-xl p-8 h-full flex flex-col opacity-100 animate-fade-in-up">
                        ...
                        <div className="border-2 border-brand-primary rounded-xl p-8 shadow-2xl relative h-full flex flex-col opacity-100 animate-fade-in-up-delay-1">
                        ...
                        <div className="border border-slate-200 dark:border-slate-700 rounded-xl p-8 h-full flex flex-col opacity-100 animate-fade-in-up-delay-2">
