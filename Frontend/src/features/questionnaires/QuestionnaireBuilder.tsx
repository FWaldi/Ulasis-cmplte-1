...
import { PlusIcon, ArrowLeftIcon, TrashIcon, ChevronUpIcon, ChevronDownIcon, DuplicateIcon, GripVerticalIcon } from '../../components/ui/Icons';
...
const QuestionnaireBuilder: React.FC<QuestionnaireBuilderProps> = ({ questionnaire, onClose, onSave }) => {
    ...
    const handleSave = () => {
        ...
        onSave(isNew ? finalData : { id: questionnaire?.id, ...finalData });
    };
